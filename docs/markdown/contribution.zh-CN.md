...
以下是关于向 Mone 提交代码的指南。在向 Mone 提交 Issue 或者 PR 之前，请先花几分钟时间阅读以下文字。
...
git remote add upstream https://github.com/jczzq/mone.git
...
```bash
git clone git@github.com:jczzq/mone.git
