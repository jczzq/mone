...
// CONCATENATED MODULE: ./es/config.js
/* harmony default export */ var es_config = ({
  silent: true,
  rowsName: 'data.rows',
...
// CONCATENATED MODULE: ./es/core/global-api/index.js
...
// CONCATENATED MODULE: ./es/core/index.js



function core_Mone(options) {
  if (false) {}
}

initGlobalAPI(core_Mone);
/* harmony default export */ var core = (core_Mone);
...
function es_install(Vue) {
  var components = [es_button, core, es_icon, es_info, es_loading, locale, view];
