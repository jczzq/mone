...
export const VIEW_TYPES = [{
  ...
  triggerTypes: ["select", "select-all", "selection-change", "cell-mouse", "cell-click", "cell-dblclick", "row-click", "row-contextmenu", "row-dblclick", "header-click", "header-contextmenu", "sort-change"],
  virtualProps: {
    hideKeys: {
      type: Array
    },
